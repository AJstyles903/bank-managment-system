    ...
    for i in range(len(student_bank_account)):
      if account_num==student_bank_account[i].accountNum:
        ...
        if choice==1:
            ...
            student_bank_account[i].deposit(depo)
        elif choice==2:
            depo=int(input("Enter Withdraw Amount: "))
            student_bank_account[i].withdraw(depo)
        elif choice==3:
            student_bank_account[i].activate_account()
        elif choice==4:
            student_bank_account[i].deactivate_account()
        else:
...
def print_student_transaction():
    for i in range(len(student_bank_account)):
        student_bank_account[i].display_transaction()
